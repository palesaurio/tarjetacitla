...
import { Facebook, Mail, Phone, Calculator, Headphones, Twitter, Instagram, Youtube, Copy } from "lucide-react"
...
export default function DigitalCard() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: "Contacta a Citlallin Castellanos Méndez - Contadora y Renta de Audio",
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-pink-100 to-rose-100 p-4">
      <Card className="w-full max-w-md overflow-hidden rounded-xl bg-white shadow-xl">
        <div className="relative h-40 bg-gradient-to-r from-pink-400 to-rose-300">
          <div className="absolute bottom-0 left-0 right-0 flex justify-center">
            <div className="relative h-32 w-32 translate-y-16 overflow-hidden rounded-full border-4 border-white bg-white">
              <Image
        ...
        <CardContent className="mt-20 p-6">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800">Citlallin Castellanos Méndez</h1>
          ...
          <Tabs defaultValue="contact" className="mt-6" onValueChange={setActiveTab}>
            ...
            <TabsContent value="contact" className="space-y-4 py-4">
              <div
                ...
                onClick={() => copyToClipboard("2282535100", "Número de teléfono")}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">228 253 5100</div>
                  </div>
                </div>
              ...
              <div
                className="flex cursor-pointer items-center justify-between rounded-lg border p-3 transition-colors hover:bg-gray-50"
                onClick={() => copyToClipboard("2282535100", "WhatsApp")}
              >
                <div className="flex items-center gap-3">
              ...
              <div
                className="flex cursor-pointer items-center justify-between rounded-lg border p-3 transition-colors hover:bg-gray-50"
                onClick={() => copyToClipboard("citlacastellanos23@gmail.com", "Correo electrónico")}
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-pink-100 text-pink-600">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">citlacastellanos23@gmail.com</div>
                  </div>
                </div>
                <Copy className="h-4 w-4 text-gray-400" />
              </div>
            ...
            <TabsContent value="social" className="space-y-4 py-4">
              <a
                href="https://www.facebook.com/share/1Fn4jiYrwQ/"
                target="_blank"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Citlallin Castellanos</div>
                  </div>
                </div>
              </a>
          ...
          <div className="mt-6 flex gap-2">
            <Button
              ...
              onClick={() => {
                if (activeTab === "contact") {
                  window.location.href = `tel:2282535100`
                } else {
                  window.location.href = "https://www.facebook.com/share/1Fn4jiYrwQ/"
                }
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                if (activeTab === "contact") {
                  window.location.href = `https://wa.me/522282535100`
                } else {
                  shareCard()
                }
              }}
          ...
          <Button
            className="mt-4 w-full bg-rose-500 hover:bg-rose-600 flex items-center justify-center gap-2"
            onClick={shareCard}
          >
          ...
          <div className="mt-6 text-center text-xs text-gray-500">
            © {new Date().getFullYear()} Citlallin Castellanos Méndez
          </div>
        </CardContent>
      </Card>
    </div>
